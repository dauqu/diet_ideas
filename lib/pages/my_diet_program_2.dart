...
class MyDietProgram2 extends StatefulWidget {
  const MyDietProgram2({super.key});

  @override
  State<MyDietProgram2> createState() => _MyDietProgram2State();
}

class _MyDietProgram2State extends State<MyDietProgram2> {
  @override
